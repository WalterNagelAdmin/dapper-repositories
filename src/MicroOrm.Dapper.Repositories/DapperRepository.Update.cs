...
namespace MicroOrm.Dapper.Repositories
{
        ...
        where TEntity : class
    {
        ...
        /// <inheritdoc />
        public virtual bool Update(TEntity instance, IDbTransaction transaction = null, params Expression<Func<TEntity, object>>[] includes)
        {
        ...
        /// <inheritdoc />
        public virtual bool Update(Expression<Func<TEntity, bool>> predicate, TEntity instance, IDbTransaction transaction = null, params Expression<Func<TEntity, object>>[] includes)
        {
        ...
        /// <inheritdoc />
        public virtual async Task<bool> UpdateAsync(TEntity instance, IDbTransaction transaction = null, params Expression<Func<TEntity, object>>[] includes)
        {
            var sqlQuery = SqlGenerator.GetUpdate(instance, includes);
        ...
        /// <inheritdoc />
        public virtual async Task<bool> UpdateAsync(Expression<Func<TEntity, bool>> predicate, TEntity instance, IDbTransaction transaction = null, params Expression<Func<TEntity, object>>[] includes)
        {
            var sqlQuery = SqlGenerator.GetUpdate(predicate, instance, includes);
            var updated = await Connection.ExecuteAsync(sqlQuery.GetSql(), sqlQuery.Param, transaction) > 0;
            return updated;
